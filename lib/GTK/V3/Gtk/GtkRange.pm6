...
=TITLE GTK::V3::Gtk::GtkRange

=SUBTITLE GtkRange — Base class for widgets which visualize an adjustment

  unit class GTK::V3::Gtk::GtkRange;
...
unit class GTK::V3::Gtk::GtkRange:auth<github:MARTIMM>;
also is GTK::V3::Gtk::GtkWidget;
...
submethod BUILD ( *%options ) {
  ...
  return unless self.^name eq 'GTK::V3::Gtk::GtkRange';
