...
=TITLE GTK::V3::Gtk::GtkScale

=SUBTITLE GtkScale — A slider widget for selecting a value from a range

  unit class GTK::V3::Gtk::GtkScale;
  also is GTK::V3::Gtk::GtkRange;
...
submethod BUILD ( *%options ) {
  ...
  return unless self.^name eq 'GTK::V3::Gtk::GtkScale';
...
=item $pos; the position in which the current value is displayed. This value is of type GtkPositionType found in C<GTK::V3::Gtk::GtkEnums>.
...
Returns the position in which the current value is displayed. The value is an enum type GtkPositionType defined in C<GTK::V3::Gtk::GtkEnums>.
...
=item $position; where to draw the mark. For a horizontal scale, GTK_POS_TOP and GTK_POS_LEFT are drawn above the scale, anything else below. For a vertical scale, GTK_POS_LEFT and GTK_POS_TOP are drawn to the left of the scale, anything else to the right. This is an enum type of C<GtkPositionType> defined in C<GTK::V3::Gtk::GtkEnums>.
